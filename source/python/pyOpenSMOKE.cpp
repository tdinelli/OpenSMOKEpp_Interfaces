...
PYBIND11_MODULE(pyOpenSMOKE, m) {
  ...
  py::class_<OpenSMOKE::ThermodynamicsMap_CHEMKIN>(m, "ThermodynamicsMap_CHEMKIN")
      ...
      .def("IndexOfElement", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::IndexOfElement, call_guard,
           ...
           py::arg("name"))
      .def("atomic_composition", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::atomic_composition,
           call_guard,
  ...
  py::class_<OpenSMOKE::KineticsMap_CHEMKIN>(m, "KineticsMap_CHEMKIN")
      ...
      .def("SetVerboseOutput", &OpenSMOKE::KineticsMap_CHEMKIN::SetVerboseOutput, call_guard,
           "Sets the verbose output", py::arg("verbose"))
      ...
      .def("ProductionAndDestructionRatesGross",
           &OpenSMOKE::KineticsMap_CHEMKIN::ProductionAndDestructionRatesGross, call_guard,
           "Calculates the production and the destruction rates for all the species in "
           "the kinetic mechanism [kmol/m3/s], the contributions are calculated on the "
      ...
      .def("GiveMeReactionRates",
           py::overload_cast<double*>(&OpenSMOKE::KineticsMap_CHEMKIN::GiveMeReactionRates),
           call_guard, "Returns the net reaction rates in [kmol/m3/s]", py::arg("r"))
      .def("GetForwardReactionRates", &OpenSMOKE::KineticsMap_CHEMKIN::GetForwardReactionRates,
           call_guard,
      ...
      .def("GetBackwardReactionRates",
           ...
           py::arg("r"))
      .def("ReactionRates",
           py::overload_cast<const double*>(&OpenSMOKE::KineticsMap_CHEMKIN::ReactionRates),
           call_guard,
      ...
      .def("KineticConstants",
           py::overload_cast<>(&OpenSMOKE::KineticsMap_CHEMKIN::KineticConstants), call_guard,
      ...
      .def("kArrheniusModified", &OpenSMOKE::KineticsMap_CHEMKIN::KArrheniusModified,
           call_guard, "Returns the modified Arrhenius kinetic constants in [kmol, m, s]")
      ...
      .def("Beta_falloff_inf", &OpenSMOKE::KineticsMap_CHEMKIN::Beta_falloff_inf, call_guard,
           "")
      .def("E_over_R_falloff_inf", &OpenSMOKE::KineticsMap_CHEMKIN::E_over_R_falloff_inf,
           call_guard, "")
      .def("IndicesOfFallOffReactions",
           &OpenSMOKE::KineticsMap_CHEMKIN::IndicesOfFalloffReactions, call_guard, "");
