...
PYBIND11_MODULE(pyOpenSMOKE, m) {
  ...
  py::class_<OpenSMOKE::ThermodynamicsMap_CHEMKIN>(m, "ThermodynamicsMap_CHEMKIN")
      ...
      .def("NumberOfSpecies", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::NumberOfSpecies, call_guard,
           "Function that returns the total number of species inside the mechanism")
      .def("NamesOfSpecies", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::NamesOfSpecies, call_guard,
      ...
      .def("MW", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::MW, call_guard,
           "Function that returns the molecular weight of the i-th species [kg/kmol]", py::arg("i"))
      .def("IndexOfSpecies", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::IndexOfSpecies, call_guard,
           "Function that returns the index of the species (1-based) given the name, if the species is not present "
           "returns an error",
           py::arg("name"))
      .def("IndexOfElement", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::IndexOfElement, call_guard,
           "Function that returns the index of the element given the name, if the element is not present returns an "
           "error",
           py::arg("name"))
      .def("atomic_composition", &OpenSMOKE::ThermodynamicsMap_CHEMKIN::atomic_composition, call_guard,
           "Returns the matrix describing the elemental composition of every species. NS x NE where NS is number of "
           "species and NE is number of elements")
  ...
  py::class_<OpenSMOKE::KineticsMap_CHEMKIN>(m, "KineticsMap_CHEMKIN")
      .def(py::init<const OpenSMOKE::KineticsMap_CHEMKIN&>(), call_guard,
           R"pbdoc(Copy constructor of the original OpenSMOKE class)pbdoc", py::arg("rhs"))
      .def("SetVerboseOutput", &OpenSMOKE::KineticsMap_CHEMKIN::SetVerboseOutput, call_guard, "Sets the verbose output",
           py::arg("verbose"))
      .def("SetTemperature", &OpenSMOKE::KineticsMap_CHEMKIN::SetTemperature, call_guard,
           "Set the temperature at which the properties have to be evaluated, T in [K]", py::arg("T"))
      .def("SetPressure", &OpenSMOKE::KineticsMap_CHEMKIN::SetPressure, call_guard,
           "Set the pressure at which the properties have to be evaluated, P in [Pa]", py::arg("P"))
      ...
      .def("FormationRates", &OpenSMOKE::KineticsMap_CHEMKIN::FormationRates, call_guard,
           "Function that computes the formation rates for all the species inside the kinetic mechanism",
           py::arg("R"))
      .def("HeatRelease", &OpenSMOKE::KineticsMap_CHEMKIN::HeatRelease, call_guard,
           ...
           py::arg("R"))
      .def("ProductionAndDestructionRates", &OpenSMOKE::KineticsMap_CHEMKIN::ProductionAndDestructionRates, call_guard,
           ...
           py::arg("P"), py::arg("D"))
      .def("ProductionAndDestructionRatesGross", &OpenSMOKE::KineticsMap_CHEMKIN::ProductionAndDestructionRatesGross,
           call_guard,
           "Calculates the production and the destruction rates for all the species in "
           "the kinetic mechanism [kmol/m3/s], the contributions are calculated on the "
           "basis of separate forward and backward reaction rates",
           py::arg("P"), py::arg("D"))
      .def("GiveMeReactionRates", py::overload_cast<>(&OpenSMOKE::KineticsMap_CHEMKIN::GiveMeReactionRates), call_guard,
           "Returns the net reaction rates in [kmol/m3/s]")
      .def("GiveMeReactionRates", py::overload_cast<double*>(&OpenSMOKE::KineticsMap_CHEMKIN::GiveMeReactionRates),
           call_guard, "Returns the net reaction rates in [kmol/m3/s]", py::arg("r"))
      .def("GetForwardReactionRates", &OpenSMOKE::KineticsMap_CHEMKIN::GetForwardReactionRates, call_guard,
           "Returns the forward reaction rates for all the reactions in the kinetic "
           "scheme [kmol/m3/s]",
           py::arg("r"))
      .def("GetBackwardReactionRates", &OpenSMOKE::KineticsMap_CHEMKIN::GetBackwardReactionRates, call_guard,
           ...
           py::arg("r"))
      .def("ReactionRates", py::overload_cast<const double*>(&OpenSMOKE::KineticsMap_CHEMKIN::ReactionRates),
           call_guard,
           ...
           py::arg("c"))
      .def("ReactionRates",
           py::overload_cast<const double*, const double>(&OpenSMOKE::KineticsMap_CHEMKIN::ReactionRates), call_guard,
           "Calculates the reaction rates for all the reactions in the kinetic scheme, c "
           "input param concentration of species in [kmol/m3], cTot total concentration "
           "in [kmol/m3]",
           py::arg("c"), py::arg("cTot"))
      .def("KineticConstants", py::overload_cast<>(&OpenSMOKE::KineticsMap_CHEMKIN::KineticConstants), call_guard,
           "Calculates the kinetic constants")
      ...
      .def("kArrheniusModified", &OpenSMOKE::KineticsMap_CHEMKIN::KArrheniusModified, call_guard,
           "Returns the modified Arrhenius kinetic constants in [kmol, m, s]")
      .def("A_falloff_inf", &OpenSMOKE::KineticsMap_CHEMKIN::A_falloff_inf, call_guard, "")
      .def("Beta_falloff_inf", &OpenSMOKE::KineticsMap_CHEMKIN::Beta_falloff_inf, call_guard, "")
      .def("E_over_R_falloff_inf", &OpenSMOKE::KineticsMap_CHEMKIN::E_over_R_falloff_inf, call_guard, "")
      .def("IndicesOfFallOffReactions", &OpenSMOKE::KineticsMap_CHEMKIN::IndicesOfFalloffReactions, call_guard, "");
  ...
  py::class_<OpenSMOKE::TransportPropertiesMap_CHEMKIN>(m, "TransportPropertiesMap_CHEMKIN")
      .def(py::init<const OpenSMOKE::TransportPropertiesMap_CHEMKIN&>(), call_guard,
           R"pbdoc(Copy constructor of the original OpenSMOKE class)pbdoc", py::arg("rhs"))
      .def("SetTemperature", &OpenSMOKE::TransportPropertiesMap_CHEMKIN::SetTemperature, call_guard)
      .def("SetPressure", &OpenSMOKE::TransportPropertiesMap_CHEMKIN::SetPressure, call_guard)
      .def("SetCoefficients", &OpenSMOKE::TransportPropertiesMap_CHEMKIN::SetCoefficients, call_guard);
